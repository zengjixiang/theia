...
- `@theia/core/shared/...`
    ...
    - `@theia/application-package` (from [`@theia/application-package@1.26.0`](https://www.npmjs.com/package/@theia/application-package/v/1.26.0))
    - `@theia/application-package/lib/api` (from [`@theia/application-package@1.26.0`](https://www.npmjs.com/package/@theia/application-package/v/1.26.0))
    - `@theia/application-package/lib/environment` (from [`@theia/application-package@1.26.0`](https://www.npmjs.com/package/@theia/application-package/v/1.26.0))
    - `@theia/request` (from [`@theia/request@1.26.0`](https://www.npmjs.com/package/@theia/request/v/1.26.0))
    - `@theia/request/lib/proxy` (from [`@theia/request@1.26.0`](https://www.npmjs.com/package/@theia/request/v/1.26.0))
    - `@theia/request/lib/node-request-service` (from [`@theia/request@1.26.0`](https://www.npmjs.com/package/@theia/request/v/1.26.0))
    ...
    - `vscode-jsonrpc` (from [`vscode-jsonrpc@^8.0.1`](https://www.npmjs.com/package/vscode-jsonrpc))
    - `vscode-jsonrpc/browser` (from [`vscode-jsonrpc@^8.0.1`](https://www.npmjs.com/package/vscode-jsonrpc))
    - `vscode-jsonrpc/node` (from [`vscode-jsonrpc@^8.0.1`](https://www.npmjs.com/package/vscode-jsonrpc))
